...
module.exports = {
  ...
  author: {
    ...
    name: 'LongchuanYu', // 必需
    link: 'https://github.com/LongchuanYu', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:remly@qq.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/LongchuanYu',
      },
      {
        iconClass: 'icon-erji',
        title: '听音乐',
  ...
  footer: {
    ...
    copyrightInfo:
      'LiYang All Rights Reserved | <a href="https://beian.miit.gov.cn/" target="_blank">黔ICP备19006556号-1</a>', // 博客版权信息，支持a标签
  },
